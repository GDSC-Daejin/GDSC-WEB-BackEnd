...
import static Gdsc.web.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        response.addHeader("Set-Cookie", "refreshToken=" + refreshToken.getToken() + "; Max-Age=" + cookieMaxAge + "; Path=/" + "Secure; SameSite = None" );
